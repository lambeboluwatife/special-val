                  ...
                  >
                    ...
                    <section className="space-y-6">
                      <div className="flex items-center gap-3">
                        ...
                        <h3 className="text-xl font-bold">The Opening Hook</h3>
                      </div>
                ...
                {wizardStep === 3 && (
                  ...
                  >
                    <div className="text-center md:text-left">
                      ...
                      <p className="text-gray-500  text-base leading-relaxed">
                        Write your final romantic vow and romantic gifts or
                    ...
                    <section className="bg-white p-4 md:p-8 rounded-xl border border-[#e6dbdd] shadow-sm">
                      <div className="flex items-center gap-3 mb-6">
                        <Sparkles className="text-primary" />
                        <h3 className="text-xl font-bold">The Success Vow</h3>
                      </div>
                      <div className="grid gap-6">
                        <div className="flex flex-col gap-2">
                    ...
                    <section className="bg-white p-4 md:p-8 rounded-xl border border-[#e6dbdd]  shadow-sm">
                      <div className="flex items-center justify-between mb-8">
                        <div className="flex items-center gap-3">
                          ...
                          <h3 className="text-xl font-bold">Digital Gifts</h3>
                        </div>
                      </div>
                    ...
                    <section className="bg-white p-4 md:p-8 rounded-xl border border-[#e6dbdd]  shadow-sm">
                      <div className="flex items-center gap-3 mb-6">
                        ...
                        <h3 className="text-xl font-bold">The Final Details</h3>
                      </div>
